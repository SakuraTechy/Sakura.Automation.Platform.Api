...
(10002, 'Gitee', 10000, 2, 'https://gitee.com/continew/sakura', NULL, NULL, NULL, 'gitee', b'1', b'0', b'0', NULL, 2, 1, 1, NOW(), NULL, NULL),
(10003, 'GitHub', 10000, 2, 'https://github.com/charles7c/sakura', NULL, NULL, NULL, 'github', b'1', b'0', b'0', NULL, 3, 1, 1, NOW(), NULL, NULL);
...
VALUES
(1, 'SITE', '系统标题', 'SITE_TITLE', NULL, 'Sakura Automation Platform', '用于显示登录页面的系统标题。', NULL, NULL),
(2, 'SITE', '系统描述', 'SITE_DESCRIPTION', NULL, '持续迭代优化的一站式持续自动化平台', NULL, NULL, NULL),
(3, 'SITE', '版权信息', 'SITE_COPYRIGHT', NULL, 'Copyright © 2024 - present SakuraTech 版权所有', '用于显示登录页面的底部版权信息。', NULL, NULL),
(4, 'SITE', '备案号', 'SITE_BEIAN', NULL, '津ICP备2024005864号-3', 'ICP备案号', NULL, NULL),
...
VALUES
(1, '开发环境', 'local_dev', 2, NULL, NULL, NULL, 'C:/sakura/data/file/', 'http://localhost:8000/file', '本地存储', b'1', 1, 1, 1, NOW(), NULL, NULL),
