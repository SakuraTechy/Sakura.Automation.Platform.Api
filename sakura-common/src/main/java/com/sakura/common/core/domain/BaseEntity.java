...
//    protected String createDeptName;
    ...
    /**
     * 是否是新记录（默认：false），调用 setIsNewRecord()设置新记录，使用自定义ID。
    ...
    public void preUpdate() {
        ...
        if (null != loginUser.getUser()) {
            ...
            this.updateByName = loginUser.getUser().getName();
            this.updateIp = loginUser.getIpaddr();
        } else {
            this.updateBy = "1";
            this.createByName = "管理员";
    ...
    public void preInsert() {
        ...
        if (null != loginUser.getUser()) {
            ...
            this.createByName = loginUser.getUser().getName();
            this.updateBy = loginUser.getUser().getId() + "";
            this.updateByName = loginUser.getUser().getName();
