...
import com.sakura.system.util.ValidateGroup;
import com.sakura.starter.extension.crud.model.req.BaseReq;
...
public class StorageReq extends BaseReq {
     ...
     * 桶名称
     */
    @Schema(description = "桶名称", example = "C:/sakura/data/file/")
