package com.sakura.common.utils.poi;

import com.sakura.common.annotation.Excel;
import com.sakura.common.annotation.Excel.ColumnType;
...
import com.sakura.common.utils.file.FileTypeUtils;
...
public class ExcelUtil<T> {
    private static final Logger log = LoggerFactory.getLogger(com.sakura.common.utils.poi.ExcelUtil.class);
    ...
    public String getAbsoluteFile(String filename) {
        String downloadPath = SakuraConfig.getDownloadPath() + filename;
