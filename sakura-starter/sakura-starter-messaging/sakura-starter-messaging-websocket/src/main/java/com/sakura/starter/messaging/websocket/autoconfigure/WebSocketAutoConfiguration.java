...
package com.sakura.starter.messaging.websocket.autoconfigure;
...
import com.sakura.starter.messaging.websocket.core.WebSocketClientService;
import com.sakura.starter.messaging.websocket.core.WebSocketInterceptor;
import com.sakura.starter.messaging.websocket.dao.WebSocketSessionDao;
import com.sakura.starter.messaging.websocket.dao.WebSocketSessionDaoDefaultImpl;
...
public class WebSocketAutoConfiguration {
    ...
    public WebSocketHandler webSocketHandler(WebSocketSessionDao webSocketSessionDao) {
        return new com.sakura.starter.messaging.websocket.core.WebSocketHandler(properties, webSocketSessionDao);
    }
    ...
    public void postConstruct() {
        log.debug("[SakurA Starter] - Auto Configuration 'Messaging-WebSocket' completed initialization.");
    }
}
