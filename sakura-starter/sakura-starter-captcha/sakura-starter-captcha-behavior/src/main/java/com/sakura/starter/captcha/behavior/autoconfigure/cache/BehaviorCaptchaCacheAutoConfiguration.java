...
package com.sakura.starter.captcha.behavior.autoconfigure.cache;

import cn.hutool.extra.spring.SpringUtil;
import com.anji.captcha.service.CaptchaCacheService;
import com.anji.captcha.service.impl.CaptchaCacheServiceMemImpl;
import com.anji.captcha.service.impl.CaptchaServiceFactory;
import com.sakura.starter.captcha.behavior.enums.StorageType;
...
import com.sakura.starter.cache.redisson.autoconfigure.RedissonAutoConfiguration;
...
public class BehaviorCaptchaCacheAutoConfiguration {
    ...
    public static class Default {
        ...
        public void postConstruct() {
            ...
            log.debug("[SakurA Starter] - Auto Configuration 'Captcha-Behavior-Cache-Default' completed initialization.");
        }
    }
    ...
    public static class Redis {
        ...
        public void postConstruct() {
            ...
            log.debug("[SakurA Starter] - Auto Configuration 'Captcha-Behavior-Cache-Redis' completed initialization.");
        }
    }
    ...
    public static class Custom {
        ...
        public void postConstruct() {
            ...
            log.debug("[SakurA Starter] - Auto Configuration 'Captcha-Behavior-Cache-Custom' completed initialization.");
        }
    }
}
