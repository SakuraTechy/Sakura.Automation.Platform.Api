...
package com.sakura.starter.extension.crud.autoconfigure;
...
public class CrudRestControllerAutoConfiguration extends DelegatingWebMvcConfiguration {
    ...
    public void postConstruct() {
        log.debug("[SakurA Starter] - Auto Configuration 'Extension-CRUD REST Controller' completed initialization.");
    }
}
