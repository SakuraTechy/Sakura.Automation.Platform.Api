...
package com.sakura.starter.extension.tenant.autoconfigure;
...
import com.sakura.starter.extension.tenant.config.TenantDataSourceProvider;
...
public class TenantAutoConfiguration {
    ...
    public static class Line {
        static {
            log.debug("[SakurA Starter] - Auto Configuration 'Tenant-Line' completed initialization.");
        }
    ...
    public static class DataSource {
        static {
            log.debug("[SakurA Starter] - Auto Configuration 'Tenant-DataSource' completed initialization.");
        }
