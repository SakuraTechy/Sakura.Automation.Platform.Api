...
package com.sakura.starter.security.limiter.autoconfigure;
...
import com.sakura.starter.security.limiter.core.DefaultRateLimiterNameGenerator;
import com.sakura.starter.security.limiter.core.RateLimiterNameGenerator;
...
@ComponentScan({"com.sakura.starter.security.limiter.core"})
...
public class RateLimiterAutoConfiguration {
    ...
    public void postConstruct() {
        log.debug("[SakurA Starter] - Auto Configuration 'Security-RateLimiter' completed initialization.");
    }
}
