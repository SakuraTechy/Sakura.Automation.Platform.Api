...
package com.sakura.starter.security.limiter.core;

import cn.hutool.core.convert.Convert;
import cn.hutool.core.text.CharSequenceUtil;
import cn.hutool.core.util.ObjectUtil;
import cn.hutool.extra.servlet.JakartaServletUtil;
import com.sakura.starter.security.limiter.annotation.RateLimiter;
import com.sakura.starter.security.limiter.annotation.RateLimiters;
import com.sakura.starter.security.limiter.autoconfigure.RateLimiterProperties;
import com.sakura.starter.security.limiter.enums.LimitType;
import com.sakura.starter.security.limiter.exception.RateLimiterException;
...
import com.sakura.starter.core.util.expression.ExpressionUtils;
import com.sakura.starter.web.util.SpringWebUtils;

import java.lang.reflect.Method;
import java.util.Objects;
import java.util.concurrent.ConcurrentHashMap;

import static com.sakura.starter.security.limiter.enums.LimitType.*;
...
public class RateLimiterAspect {
     ...
     * 单个限流注解切点
     */
    @Pointcut("@annotation(com.sakura.starter.security.limiter.annotation.RateLimiter)")
     ...
     * 多个限流注解切点
     */
    @Pointcut("@annotation(com.sakura.starter.security.limiter.annotation.RateLimiters)")
    ...
    private boolean isRateLimited(ProceedingJoinPoint joinPoint, RateLimiter rateLimiter) {
        try {
            ...
            // 限流器配置
            RateType rateType = rateLimiter.type() == CLUSTER ? RateType.PER_CLIENT : RateType.OVERALL;
