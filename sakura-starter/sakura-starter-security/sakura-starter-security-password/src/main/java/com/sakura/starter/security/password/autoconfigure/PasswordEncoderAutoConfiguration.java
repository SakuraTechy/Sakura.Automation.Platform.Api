...
package com.sakura.starter.security.password.autoconfigure;
...
public class PasswordEncoderAutoConfiguration {
    ...
    public void postConstruct() {
        log.debug("[SakurA Starter] - Auto Configuration 'Security-PasswordEncoder' completed initialization.");
    }
}
