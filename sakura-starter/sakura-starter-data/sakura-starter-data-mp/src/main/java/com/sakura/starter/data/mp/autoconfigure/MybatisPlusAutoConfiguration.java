...
package com.sakura.starter.data.mp.autoconfigure;
...
import com.sakura.starter.data.mp.autoconfigure.idgenerator.MyBatisPlusIdGeneratorConfiguration;
import com.sakura.starter.data.mp.handler.MybatisBaseEnumTypeHandler;
...
public class MybatisPlusAutoConfiguration {
    ...
    public void postConstruct() {
        log.debug("[SakurA Starter] - Auto Configuration 'MyBatis Plus' completed initialization.");
    }
}
