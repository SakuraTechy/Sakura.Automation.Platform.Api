...
package com.sakura.starter.data.mp.autoconfigure.idgenerator;
...
public class MyBatisPlusIdGeneratorConfiguration {
    ...
    public static class Default {
        static {
            log.debug("[SakurA Starter] - Auto Configuration 'MyBatis Plus-IdGenerator-Default' completed initialization.");
        }
    ...
    public static class CosId {
        static {
            log.debug("[SakurA Starter] - Auto Configuration 'MyBatis Plus-IdGenerator-CosId' completed initialization.");
        }
