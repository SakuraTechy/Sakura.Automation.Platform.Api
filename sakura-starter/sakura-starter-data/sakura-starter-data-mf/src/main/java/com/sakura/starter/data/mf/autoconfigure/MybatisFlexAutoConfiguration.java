...
package com.sakura.starter.data.mf.autoconfigure;
...
import com.sakura.starter.data.mf.datapermission.DataPermissionDialect;
import com.sakura.starter.data.mf.datapermission.DataPermissionFilter;
...
public class MybatisFlexAutoConfiguration {
    ...
    public void postConstruct() {
        log.debug("[SakurA Starter] - Auto Configuration 'MyBatis Flex' completed initialization.");
