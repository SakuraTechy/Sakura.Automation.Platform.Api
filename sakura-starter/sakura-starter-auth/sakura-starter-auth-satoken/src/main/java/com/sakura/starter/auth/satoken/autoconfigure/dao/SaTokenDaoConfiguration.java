...
public class SaTokenDaoConfiguration {
    ...
    public static class Default {
        static {
            log.debug("[SakurA Starter] - Auto Configuration 'SaToken-Dao-Default' completed initialization.");
        }
    ...
    public static class Redis {
        static {
            log.debug("[SakurA Starter] - Auto Configuration 'SaToken-Dao-Redis' completed initialization.");
        }
