...
package com.sakura.starter.auth.satoken.autoconfigure;
...
import com.sakura.starter.auth.satoken.autoconfigure.dao.SaTokenDaoConfiguration;
...
public class SaTokenAutoConfiguration implements WebMvcConfigurer {
    ...
    public void postConstruct() {
        log.debug("[SakurA Starter] - Auto Configuration 'SaToken' completed initialization.");
    }
}
