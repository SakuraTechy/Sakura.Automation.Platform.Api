...
import com.sakura.common.enums.BusinessStatus;
import com.sakura.common.enums.HttpMethod;
...
public class LogAspect {
    ...
    // 配置织入点
    @Pointcut("@annotation(com.sakura.common.annotation.Log)")
    public void logPointCut() {
    }

    @Around("@annotation(com.sakura.common.annotation.Log)")
