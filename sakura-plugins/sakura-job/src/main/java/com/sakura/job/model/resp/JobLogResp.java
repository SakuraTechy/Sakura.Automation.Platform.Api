...
package com.sakura.job.model.resp;

import com.sakura.job.enums.JobExecuteReasonEnum;
import com.sakura.job.enums.JobExecuteStatusEnum;
...
public class JobLogResp implements Serializable {
     ...
     * 任务组
     */
    @Schema(description = "任务组", example = "sakura")
