...
package com.sakura.generator.model.resp;
...
public class GeneratePreviewResp implements Serializable {
    ...
    @Schema(description = "生成的文件路径", example = "sakura\\sakura\\sakura-generator\\src\\main\\java\\top\\continew\\admin\\generator\\service")
    private String path;
