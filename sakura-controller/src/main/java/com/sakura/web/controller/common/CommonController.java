...
import com.sakura.common.utils.file.FileUtils;
import com.sakura.framework.config.ServerConfig;
...
public class CommonController
{
    ...
    public void fileDownload(String fileName, Boolean delete, HttpServletResponse response, HttpServletRequest request)
    {
        try
        {
            ...
            String filePath = SakuraConfig.getDownloadPath() + fileName;
    ...
    public AjaxResult uploadFile(MultipartFile file) throws Exception
    {
        ...
        {
            // 上传文件路径
            String filePath = SakuraConfig.getUploadPath();
            // 上传并返回新文件名称
